...
router.post('/signup', [
    express_validator_1.body('email').isEmail().withMessage('Invalid Email').custom(function (value, _a) {
        var req = _a.req;
        return __awaiter(void 0, void 0, void 0, function () {
            var user;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, user_1.default.findByEmail(value)];
                    case 1:
                        user = _b.sent();
                        if (user) {
                            return [2 /*return*/, Promise.reject("E-mail already exists!")];
                        }
                        return [2 /*return*/];
                }
            });
